...
if os.environ.get('DB_ENGINE', '').lower() == 'mysql':
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('DB_NAME', 'detection_of_phishing_websites'),
...
# The bundled migration history is out of sync with the current models.
# Let Django create the Remote_User tables directly from the models for local runs.
MIGRATION_MODULES = {
    'Remote_User': None,
}
