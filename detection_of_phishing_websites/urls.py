"""detection_of_phishing_websitess URL Configuration
...
from detection_of_phishing_websites import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Website_URL_Type/$', remoteuser.Predict_Website_URL_Type, name="Predict_Website_URL_Type"),
    ...
    url(r'^View_Website_URL_Type_Ratio/$', serviceprovider.View_Website_URL_Type_Ratio, name="View_Website_URL_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Website_URL_Type/$', serviceprovider.View_Prediction_Of_Website_URL_Type, name="View_Prediction_Of_Website_URL_Type"),
