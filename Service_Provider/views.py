...
DATASET_PATH = Path(__file__).resolve().parent.parent / "Website_urls.csv"
LABELED_DATASET_PATH = Path(__file__).resolve().parent.parent / "labeled_data.csv"
...
def train_model(request):
    ...
    data.to_csv(LABELED_DATASET_PATH, index=False)
    data.to_markdown
